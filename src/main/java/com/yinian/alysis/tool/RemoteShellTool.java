...
public class RemoteShellTool {
     ...
     */
     ...
     public void truncateHiveHdfsRubish(String tableName,String schema){
    	 this.exec("hadoop fs -rmr .Trash/Current/user/hive/warehouse/"+schema+".db/"+SyncCommUtil.trimTou(tableName));
     }
     ...
     public void truncateHiveTableData(String tableName,String schema,String[] partitions) {
    	 this.exec("hadoop fs -rm -r  /user/hive/warehouse/"+schema+".db/"+SyncCommUtil.trimTou(tableName)+"/day="+partitions[0]+"/hour="+partitions[1]);
     }
